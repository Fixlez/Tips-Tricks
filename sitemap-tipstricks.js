/**
 * Advanced Blogger TOC Script by tips-trickspokeronline.blogspot.com
 * URL: http:/tips-trickspokeronline.blogspot.com/
 * Templates: &lt;div id="table-outer"&gt;&lt;table border="0"&gt;&lt;tr&gt;&lt;td&gt;&lt;label&gt;Sort list by:&lt;/label&gt;&lt;/td&gt;&lt;td&gt;&lt;select id="orderFeedBy"&gt;&lt;option value="published" selected&gt;Latest Posting&lt;/option&gt;&lt;option value="updated"&gt;Posting Updated&lt;/option&gt;&lt;/select&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td&gt;&lt;label&gt;Filter list by category:&lt;/label&gt;&lt;/td&gt;&lt;td&gt;&lt;span id="labelSorter"&gt;&lt;select disabled&gt;&lt;option selected&gt;Loading...&lt;/option&gt;&lt;/select&gt;&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td&gt;&lt;label&gt;Search by keyword:&lt;/label&gt;&lt;/td&gt;&lt;td&gt;&lt;form id="postSearcher"&gt;&lt;input type="text"/&gt;&lt;/form&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;&lt;/div&gt;&lt;header id="resultDesc"&gt;&lt;/header&gt;&lt;ul id="feedContainer"&gt;&lt;/ul&gt;&lt;div id="feedNav"&gt;Loading...&lt;/div&gt;&lt;script type="text/javascript" src="advanced-toc.js"&gt;&lt;/script&gt;
 */

// This is the container template that will be used to insert post template, pagination and the posts count
document.write('<div id="itempager" style="position:relative;"><a title="Tips & Tricks" style="display:block!important;visibility:visible!important;opacity:1!important;position:absolute;bottom:10px;right:35px;font:normal bold 8px Arial,Sans-Serif!important;color:#666;text-shadow:0 1px 0 rgba(255,255,255,.1);text-decoration:none;" href="http://tips-trickspokeronline.blogspot.com/" target="_blank">&#9658;Get widget</a></div>');
...
function showFeedList(json) {
	...
	if (json.feed.entry) {
		...
		resultDesc.innerHTML = (input.value !== '' && filter == 'search') ? "<span>Search results for keywords <strong>&#8220;" + input.value + "&#8221;</strong> (" + json.feed.openSearch$totalResults.$t + " Results)</span>" : "Total: " + json.feed.openSearch$totalResults.$t + " Article";;
...
function changeSort(label) {
	...
	resultDesc.innerHTML = "Count articles&hellip;";
	feedNav.innerHTML = tocConfig.loading;
